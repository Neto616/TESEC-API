...
class ProveedorRequest extends FormRequest
{
            ...
            case "crear":
                return [
                    "nombre" => [
                        ...
                        "min:1",
                        "max:255",
                        Rule::unique("proveedores", "nombre")->where(
                            fn($q) => $q->where(
                                "estatus",
                    ...
                    "direccion" => ["nullable", "string", "min:0", "max:255"],
                ];
            case "editar":
                return [
                    "nombre" => [
    ...
    public function messages()
    {
        return [
            ...
            "logo.mimes" =>
                "El logo debe ser de un formato jpeg, png, jpg o gif",
            "estatus.in" => "El estatus debe ser activo o inactivo",
            "correo_contacto.required" =>
                "Se requiere de un correo para contactar al proveedor",
        ];
    }
}
