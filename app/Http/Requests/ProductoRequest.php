...
class ProductoRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "precio.between" =>
                "El precio excede del rango aceptado (0.00 - 99,999,999.99)",
            "precio_publico.between" =>
                "El precio excede del rango aceptado (0.00 - 99,999,999.99)",
            "imagen.image" => "El archivo debe ser una imagen válida.",
            "imagen.mimes" =>
                "La imagen debe ser formato: jpg, jpeg, png o webp.",
            "imagen.max" => "La imagen no debe pesar más de 2MB.",
            "estatus.in" => "El estatus debe ser Activo o Inactivo",
            "cantidad.numeric" =>
                "La cantidad de inventario debe ser un número.",
